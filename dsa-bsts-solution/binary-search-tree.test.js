...
/** Before each test, make test trees. */
...
describe("insert", function () {
  it("inserts a node at the root if empty tree",
    function () {
      emptyBST.insert(15);
  ...
  it("inserts node larger than current largest at far right (small)",
    function () {
      smallBST.insert(21);
  ...
  it("inserts node larger than current largest at far right (large)",
    function () {
      largeBST.insert(101);
  ...
  it("inserts node smaller than current smallest at far left (small)",
    function () {
      smallBST.insert(9);
  ...
  it("inserts node smaller than current smallest at far left (large)",
    function () {
      largeBST.insert(9);
  ...
  it("inserts penultimate largest node as left of far right node (small)",
    function () {
      smallBST.insert(19);
      expect(smallBST.root.right.val).toEqual(20);
  ...
  it("inserts penultimate largest node as left of far right node (largest)",
    function () {
      largeBST.insert(99);
      expect(largeBST.root.right.right.val).toEqual(100);
  ...
  it("inserts penultimate smallest to right place (small)",
    function () {
      smallBST.insert(11);
      expect(smallBST.root.right.val).toEqual(20);
  ...
  it("inserts penultimate smallest to right place (large)",
    function () {
      largeBST.insert(11);
      expect(largeBST.root.left.left.val).toEqual(10);
      expect(largeBST.root.left.left.right.val).toEqual(15);
  ...
  it("inserts node one bigger than root (large)",
    function () {
      largeBST.insert(51);
  ...
  it("inserts node one smaller than root (small)",
    function () {
      smallBST.insert(9);
      expect(smallBST.root.val).toEqual(10);
      expect(smallBST.root.right.val).toEqual(20);
  ...
  it("inserts node one smaller than root (large)",
    function () {
      largeBST.insert(49);
      expect(largeBST.root.val).toEqual(50);
...
describe("insertRecursively", function () {
  ...
  it(
    "inserts penultimate smallest to right place (small)",
    function () {
...
describe("find", function () {
  it("finds a leaf node correctly",
    function () {
      const foundNode = smallBST.find(20);
  ...
  it("finds root node correctly",
    function () {
      const foundNode = smallBST.find(10);
  ...
  it("finds node correctly on larger tree",
    function () {
      const foundNode = largeBST.find(10);
      expect(foundNode.val).toEqual(10);
      expect(foundNode.left).toBe(null);
  ...
  it("returns undefined if a node is not found",
    function () {
      const foundNode = smallBST.find(120);
...
describe("findRecursively", function () {
  it("finds a leaf node correctly",
    function () {
      const foundNode = smallBST.findRecursively(20);
      expect(foundNode.val).toEqual(20);
      expect(foundNode.left).toBe(null);
      expect(foundNode.right).toBe(null);
    }
  ...
  it("finds root node correctly",
    function () {
      const foundNode = smallBST.findRecursively(10);
      expect(foundNode.val).toEqual(10);
      expect(foundNode.left).toBe(null);
      expect(foundNode.right.val).toEqual(20);
    }
  ...
  it("finds node correctly on larger tree",
    function () {
      const foundNode = largeBST.findRecursively(10);
      expect(foundNode.val).toEqual(10);
      expect(foundNode.left).toBe(null);
      expect(foundNode.right.val).toEqual(15);
    }
  ...
  it("returns undefined if a node is not found",
    function () {
      const foundNode = smallBST.findRecursively(120);
      expect(foundNode).toBe(undefined);
    }
  );
});
...
describe("dfsPreOrder", function () {
  it("returns an array of values found with DFS Pre Order(small)",
    function () {
      expect(smallBST.dfsPreOrder()).toEqual([10, 20]);
    }
  );

  it("returns an array of values found with DFS Pre Order(large)",
    function () {
      expect(largeBST.dfsPreOrder()).toEqual([50, 25, 10, 15, 40, 75, 100]);
    }
  );

  it("returns an array of values found with DFS Pre Order(empty)",
    function () {
...
describe("dfsInOrder", function () {
  it("returns an array of values found with DFS In Order(small)",
    function () {
      expect(smallBST.dfsInOrder()).toEqual([10, 20]);
    }
  );

  it("returns an array of values found with DFS In Order(large)",
    function () {
      expect(largeBST.dfsInOrder()).toEqual([10, 15, 25, 40, 50, 75, 100]);
    }
  );

  it("returns an array of values found with DFS In Order(empty)",
    function () {
...
describe("dfsPostOrder", function () {
  it("returns an array of values found with DFS Post Order(small)",
    function () {
      expect(smallBST.dfsPostOrder()).toEqual([20, 10]);
    }
  );

  it("returns an array of values found with DFS Post Order(large)",
    function () {
      expect(largeBST.dfsPostOrder()).toEqual([15, 10, 40, 25, 100, 75, 50]);
    }
  );

  it("returns an array of values found with DFS Post Order(empty)",
    function () {
...
describe("bfs", function () {
  it("returns an array of values found with BFS(small)",
    function () {
      expect(smallBST.bfs()).toEqual([10, 20]);
    }
  );

  it("returns an array of values found with BFS (large)",
    function () {
      expect(largeBST.bfs()).toEqual([50, 25, 75, 10, 40, 100, 15]);
    }
  );

  it("returns an array of values found with BFS(empty)",
    function () {
...
describe("findSuccessorNode", function () {
  it("finds successor in small tree",
    function () {
      const node = smallBST.find(10);

      expect(smallBST.findSuccessorNode(node).val).toEqual(20);
    }
  );

  it("finds successor in large tree",
    function () {
      largeBST.insert(60);
      largeBST.insert(55);
      const node = largeBST.find(50);
...
describe("remove", function () {
  it("removes a root node with no children",
    function () {
      emptyBST.insert(10);
      emptyBST.remove(10);
  ...
  it("removes a (root) node with one child (small)",
    function () {
      smallBST.remove(10);
  ...
  it("removes a node with one child (large)",
    function () {
      largeBST.remove(75);
  ...
  it("removes a (root) node with two children (small)",
    function () {
      smallBST.insert(5);
  ...
  it("removes a node with two children (large)",
    function () {
      largeBST.remove(25);
  ...
  it("removes a ( root) node with two children (find inorder successor, complex)",
    function () {
      largeBST.insert(60);
      largeBST.insert(59);
